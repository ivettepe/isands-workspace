...
public interface ElectronicsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.isands.service.builder.service.impl.ElectronicsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the electronics local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ElectronicsLocalServiceUtil} if injection and service tracking are not available.
	 */
