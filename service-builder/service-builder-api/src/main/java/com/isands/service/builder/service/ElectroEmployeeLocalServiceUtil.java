 ...
 * <code>com.isands.service.builder.service.impl.ElectroEmployeeLocalServiceImpl</code> and
...
public class ElectroEmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.isands.service.builder.service.impl.ElectroEmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<ElectroEmployee> findByElectroType(Long electroTypeId) {
		return getService().findByElectroType(electroTypeId);
	}

	public static List<ElectroEmployee> findByEmployee(Long employeeId) {
