 ...
 * <code>com.isands.service.builder.service.impl.PurchaseLocalServiceImpl</code> and
...
public class PurchaseLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.isands.service.builder.service.impl.PurchaseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Purchase> getPurchases(
		...
		return getService().getPurchases(start, end, orderByComparator);
	}
