...
import com.isands.service.builder.model.impl.ElectroTypeImpl;
import com.isands.service.builder.model.impl.ElectroTypeModelImpl;
...
public class ElectroTypePersistenceImpl
	 ...
	 */
	@Override
	public List<ElectroType> findByname(String name, int start, int end) {
	 ...
	 */
	@Override
	public List<ElectroType> findByname(
	...
	public ElectroType findByname_First(
		...
		ElectroType electroType = fetchByname_First(name, orderByComparator);
	...
	public ElectroType fetchByname_First(
		...
		List<ElectroType> list = findByname(name, 0, 1, orderByComparator);
	...
	public ElectroType findByname_Last(
		...
		ElectroType electroType = fetchByname_Last(name, orderByComparator);
	...
	public ElectroType fetchByname_Last(
		...
		List<ElectroType> list = findByname(
	...
	protected ElectroType getByname_PrevAndNext(
